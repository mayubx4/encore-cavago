      ...
      <div className='relative overflow-hidden aspect-[0.85] group'>
        ...
        >
          ...
          <div className='absolute bottom-4 left-4 right-4'>
            <Button
              className='text-[#533736] mt-6 transform translate-y-full opacity-0 transition-all duration-1000 ease-in-out group-hover:translate-y-0 group-hover:opacity-100'
              shape='round'
            >
              Book Now
            </Button>
